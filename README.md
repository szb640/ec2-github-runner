...
| `ec2-base-os`                                                                                                                                                                | Required if you use the `start` mode.      | Base OS type of the EC2 image (AMI). The new runner needs to be configured based on OS and architecture: <br> - `win-x64` <br> - `linux-x64` <br> - `linux-arm` <br> - `linux-arm64`                                                                                                                                                                                     |
